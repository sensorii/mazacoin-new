...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:mazacoin/mazacoin.git mazacoin
        cd mazacoin

2.  Build mazacoind (and Mazacoin-Qt, if configured):
...
Download `https://gavinandresen-mazacoin.s3.amazonaws.com/boost_macports_fix.zip`
for a fix.
